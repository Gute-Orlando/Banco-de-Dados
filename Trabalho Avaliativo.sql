...
(1,'Gustavo Orlando','1111-1111','Gsuteh','123456','Sensei');
insert into tb_usuario values
(2,'Luquinhas','2222-2222','Lubeta','123456','Besnito');
insert into tb_usuario values
...
(null,'Gustavo Orlando','1111-1111','528','Deske@gmail.com','11111111111','Rua','111-11111',
'Rua um','PenhaZL','São Paulo','SP','456','111');

insert into tb_cliente values
(null,'Messi','2222-2222','','craque@gmail.com','22222222222','Avenida ','222-22222',
'Rua dois','Vila Champions','São Paulo','SP','','222');

insert into tb_cliente values
(null,'Penaldo','3333-3333','','Gol@gmail.com','33333333333','Rua','333-33333',
'Rua três','Vila Penalti','São Paulo','SP','769','333');

insert into tb_cliente values
(null,'Geremias','4444-4444','','nomelixo@gmail.com','44444444444','Avenida','444-44444',
'Rua quatro','Vila nomeRUim','São Paulo','SP','795','444');

insert into tb_cliente values
(null,'Ferreti','5555-5555','','SouPorco@gmail.com','55555555555','Avenida','555-55555',
'Rua cinco','Vila Porco','São Paulo','SP','467','555');
